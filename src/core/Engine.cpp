...
namespace Riot
{
    ...
    void Engine::Run( void )
    {
        ...
        while( m_bRunning )
        {
            ...
            m_pRenderer->DrawDebugBox( RVector3( -(CTerrain::TERRAIN_WIDTH >> 1), 0.0f, -(CTerrain::TERRAIN_HEIGHT >> 1) ), RVector3( (CTerrain::TERRAIN_WIDTH >> 1), CTerrain::TERRAIN_HEIGHT, (CTerrain::TERRAIN_HEIGHT >> 1)  ) );
            //////////////////////////////////////////
            // Update everything
            m_pCamera->Update();
